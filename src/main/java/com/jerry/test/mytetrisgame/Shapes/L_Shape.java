 ...
 */
public class L_Shape extends RootShape{
    ...
    */
    ...
    public L_Shape(int centerX, int centerY) {
        // rotation center
        centerBlockIndex = 2;
    ...
    public static void main(String[] args){
        ...
        L_Shape lShape = new L_Shape(2,2);

        for(int i=0;i<8;i++) {
            test_cleanMockScreen(mockScreen, mockScreenSize);
            test_boundShapeToMockScreen(mockScreen, lShape);
